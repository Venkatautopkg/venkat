...
LABEL org.label-schema.name="bigfixrecipes"
LABEL org.label-schema.description="Run recipes using AutoPkg on Ubuntu:latest"
LABEL org.label-schema.docker.cmd="docker run --rm bigfixrecipes run -vv com.github.jgstew.test.DateTimeFromString"
